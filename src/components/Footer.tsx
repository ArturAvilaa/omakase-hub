        ...
        <div className="grid md:grid-cols-3 gap-12">
          <div>
            <h3 className="font-display text-2xl font-bold mb-2">
              <span className="text-gradient-gold">桜</span> Sakura
            </h3>
            <p className="text-muted-foreground text-sm font-body leading-relaxed">
              Tradição e sabor em cada peça. Uma experiência japonesa autêntica no coração da cidade.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="space-y-1 text-sm text-muted-foreground font-body">
              <p>(11) 99999-0000</p>
              <p>contato@sakurasushi.com.br</p>
